...
export default function QuizStep({
  ...
  const handleSelect = (id: string) => {
    ...
    // FEEDBACK EMOCIONAL (NOVA CAMADA)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#E0F2FE] via-[#F8FAFC] to-[#EDE9FE]">
      <div className="max-w-xl mx-auto px-6 py-10 animate-in">
        ...
        {question.subtext && <p className="text-sm text-slate-500 mb-2">{question.subtext}</p>}
        ...
        {/* FEEDBACK DINÂMICO */}
        {feedback && (
          <div className="mb-5 p-3 bg-blue-50 border border-blue-100 rounded-xl text-sm text-blue-700 animate-in">
            {feedback}
          </div>
        )}
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${isSelected ? "border-blue-500 shadow-md shadow-blue-100" : "border-slate-100"}
                `}
              >
